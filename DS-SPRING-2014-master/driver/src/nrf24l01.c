...
//For nordic 2
void nrf24l01_power_up2(bool rx_active_mode)
{
	unsigned char config;
...
//for nordic 2
void nrf24l01_set_as_rx2(bool rx_active_mode)
{
	unsigned char config;
	unsigned char status;
